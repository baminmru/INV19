...
Public Class frmOpIn
    ...
    Private Sub cmdProcess_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdProcess.Click
        ...
        Dim request As HttpWebRequest = HttpWebRequest.Create(ServiceURL + "terminal/opin/" + UID.ToString())
        request.Method = "POST"
    ...
    Private Sub frmOpIn_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Try
    ...
    Private Sub frmOpIn_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
...
#End Region
    ...
    Private Sub txtCellCode_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCellCode.TextChanged
