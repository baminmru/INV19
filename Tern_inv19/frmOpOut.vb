...
Public Class frmOpOut
    ...
    Private Sub cmdProcess_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdProcess.Click
        ...
        If cmbDep.SelectedIndex = -1 Then
            MsgBox("Надо выбрать отдел", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, "Ошибка")
            Return
        End If
        ...
        Dim request As HttpWebRequest = HttpWebRequest.Create(ServiceURL + "terminal/opout/" + UID.ToString())
        request.Method = "POST"
        ...
        r = New invops_out
        r.quantity = NumQ.Value
        r.rfid = txtItem.Tag
        r.shCode = txtCellCode.Tag
        r.theDept = DeptList(cmbDep.SelectedIndex).id
    ...
    Private Sub LoadDept()
        ...
        Dim request As HttpWebRequest = HttpWebRequest.Create(ServiceURL + "terminal/dept")
        request.Method = "GET"
    ...
    Private Sub frmOpOut_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Try
    ...
    Private Sub frmOpOut_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        WakeUp()
